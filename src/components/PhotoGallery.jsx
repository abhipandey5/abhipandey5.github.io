...
const professorMoments = [
  {
    src: '/Pictures/612039758_1312673307565736_337257449434403930_n.jpg',
    alt: 'COMSNETS 2026 best paper award moment',
    title: 'COMSNETS 2026 · Best Paper Award',
    detail: 'A proud milestone from the conference where our work was recognized for its contribution to secure and trustworthy systems research.',
    badge: 'Award',
  },
  {
  ...
  },
  {
    ...
    alt: 'Visit to University of South-Eastern Norway under Dr. Mohsen Toorani',
    title: 'USN Visit · Norway',
    detail: 'A memorable research visit to the University of South-Eastern Norway under the guidance of Dr. Mohsen Toorani.',
    badge: 'Research Visit',
  },
  {
        ...
        <div className="grid gap-6 sm:grid-cols-2 xl:grid-cols-3">
          {professorMoments.map((photo, index) => (
            <ScrollReveal key={photo.src} delay={index * 0.08}>
              <figure className="gallery-card group overflow-hidden rounded-2xl border border-border bg-bg-card shadow-lg shadow-black/10">
                ...
                <figcaption className="p-5">
                  <div className="font-mono text-[10px] uppercase tracking-[0.2em] text-lavender mb-2">
                    {photo.badge || (photo.title.includes('Norway') ? 'Research Visit' : 'Academic Memory')}
                  </div>
